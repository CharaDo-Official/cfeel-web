		...
		<footer className="bg-white border-t border-slate-200 pt-16 pb-8 text-slate-600">
			<div className="container mx-auto max-w-7xl px-6">
				<div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
					...
					{/* Product Links */}
					<div>
						<h3 className="font-bold text-slate-900 mb-4">CharaDo</h3>
						<ul className="space-y-3 text-sm">
							<li><Link to="/charado" className="hover:text-primary transition-colors">Top</Link></li>
				...
				<div className="border-t border-slate-100 pt-8 flex flex-col md:flex-row items-center justify-between gap-4">
					...
					<p className="text-xs text-slate-400">
						Made with <span className="text-rose-400">♥</span> by CFEEL Team
					</p>
				</div>
			</div>
		</footer>
